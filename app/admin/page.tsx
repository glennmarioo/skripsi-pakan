      ...
      >
        <form onSubmit={handleProductSubmit} className="space-y-4">
          ...
          <div className="w-full flex flex-col gap-1.5">
            <label className="text-sm font-semibold text-slate-700 dark:text-slate-300">Deskripsi</label>
            <textarea 
              required 
              name="description" 
